  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:title" content="Mouse Potato Lab | Workshop" />
              ...
              <div className="bg-campaign-grey p-campaign w-full">
                <div className="flex mobile-wrap justify-between items-center mb-10">
                  <h1 className="text-3xl uppercase max-660 mobile-mb-20">
                    Take the first step with your app idea
                  </h1>
                  <Link href="/schedule">
                ...
                <div className="flex justify-between mobile-wrap">
                  <div className="w-full">
                    <div className="flex w-full mobile-wrap">
                      <div>
                        <h6 className="text-lg font-bold text-primary mb-4 mw-280">
                          What we will do
                        </h6>
                        <ol className="list-startup mb-4">
                          <li className="text-md mb-2 font-regular">
                            Use the Five W's + H technique to dive into your
                            idea
                          </li>
                          <li className="text-md mb-2 font-regular">
                          ...
                          <li className="text-md mb-2 font-regular">
                            Pinpoint MVP features
                          </li>
                          <li className="text-md mb-2 font-regular">
                            Strategize to validate your idea without spending $
                            if possible
                          </li>
                          <li className="text-md font-regular">
                            Recommend tech stack and next steps
                          </li>
                        </ol>
                      </div>
                    </div>
...
Workshop.getLayout = function getLayout(page) {
