    ...
    <>
      ...
      <main className="container m-auto" ref={ref}>
        ...
        >
          ...
          <p className="text-md mb-6">Cookie Policy for Thabit Website</p>
          <p className="text-md mb-6">Last Updated: Aug 26, 2023</p>
          ...
          <p className="text-md mb-6">What Are Cookies?</p>
          <p className="text-md mb-6">
          ...
          <p className="text-md mb-6">Types of Cookies We Use</p>
          <p className="text-md mb-6">
          ...
          <p className="text-md mb-6">How We Use Cookies</p>
          <p className="text-md mb-6">
          ...
          <p className="text-md mb-6">Third-Party Cookies</p>
          <p className="text-md mb-6">
          ...
          <p className="text-md mb-6">Updates to this Cookie Policy</p>
          <p className="text-md mb-6">
