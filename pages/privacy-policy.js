    ...
    <>
      ...
      <main className="container m-auto mb-30" ref={ref}>
        ...
        >
          ...
          <p className="text-lg mb-6">Privacy Policy for Thabit App.</p>
          ...
          <p className="text-lg mb-6">Information We Collect:</p>
          <p className="text-lg mb-6">
          ...
          <p className="text-lg mb-6">Data Sharing and Security:</p>
          <p className="text-lg mb-6">
          ...
          <p className="text-lg mb-6">Data Retention:</p>
          <p className="text-lg mb-6">
          ...
          <p className="text-lg mb-6">Updates to Privacy Policy:</p>
          <p className="text-lg mb-6">
